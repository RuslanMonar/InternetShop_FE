...
const FeatureLaptop = ({id}) => {
    
    return ( <div className="DetailsItem">
    <p className="DetailsTitle">Details</p>
    <div className="DetailsPart">
        <div className="DetailParametr">tablet</div> 
        <div className="DetailValue"> 2</div>
    </div>
    <div className="DetailsPart">
        <div className="DetailParametr">Число Sim cart</div> 
        <div className="DetailValue"> 1</div>
    </div>
    <div className="DetailsPart">
    ...
    <div className="DetailsPart">
        ...
        <div className="DetailValue"> 5</div>
    </div>
    <div className="DetailsPart">
        <div className="DetailParametr">Кількість ядер</div> 
        <div className="DetailValue"> 4</div>
    </div>
    <div className="DetailsPart">
    ...
    <div className="DetailsPart">
        <div className="DetailParametr">Тип usb</div> 
        <div className="DetailValue"> </div>
    </div>
    <div className="DetailsPart">
